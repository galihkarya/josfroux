...
const CertificateCard = (certificate: CertificateProps) => {
  return (
    <div className="certificate-card flex flex-col min-w-80 bg-bgcontainersecondary rounded-2xl border-[0.5px] border-bordercolor backdrop-blur-none shadow-lg hover:bg-bgcontainer duration-200">
      <Image
